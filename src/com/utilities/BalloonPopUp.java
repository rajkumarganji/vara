...
public class BalloonPopUp {
	static Logger log = Logger.getLogger(BalloonPopUp.class);
	static String fileSeperator = System.getProperty("file.seperator");

	/**
	 * 
	 * TODO method used to indicate the current running testcase in a balloon pop in
	 * system tray
	 * 
	 * @param testCaseName - Need to pass the Test case name which is currently
	 *                     running
	 * @throws Exception
	 */
